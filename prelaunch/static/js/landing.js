...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        form.addEventListener('submit', async (e) => {
            ...
            if (!selectedRole) {
                alert('Please select whether you are a Trader or Learner');
                return;
            }
            
            const userType = selectedRole.value;
                ...
                if (result.success) {
                    ...
                    if (result.message && result.message.includes("already on the waitlist")) {
                        ...
                        messageDiv.innerHTML = `
                            ...
                            <p style="color: #ffffff !important; font-size: 0.95rem !important; line-height: 1.5 !important; opacity: 0.9 !important; margin: 0 !important; text-align: center !important;">${result.message}</p>
                        `;
